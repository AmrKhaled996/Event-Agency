...
export const fields = {
  hobbyist: [
    ...
    { id: "countryId", label: "upgradeToOrganizer.fields.country", type: "location-select", locationType: "country", half: true, required: true },
    { id: "stateId", label: "upgradeToOrganizer.fields.state", type: "location-select", locationType: "state", dependsOn: "countryId", half: true, required: true },
    { id: "cityId", label: "upgradeToOrganizer.fields.city", type: "location-select", locationType: "city", dependsOn: "stateId", half: true, required: true },
  ...
  business: [
    ...
    { id: "ownerName",   label: "upgradeToOrganizer.fields.ownerName",           placeholder: "upgradeToOrganizer.fields.placeholders.name",        type: "text", half: true,  required: true, validate: (v) => v.trim().length < 2 ? "upgradeToOrganizer.validation.nameRequired" : null },
    { id: "contactEmail",      label: "upgradeToOrganizer.fields.email",              placeholder: "upgradeToOrganizer.fields.placeholders.email",  type: "email", half: true,  required: true,  validate: (v) => !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v) ? "upgradeToOrganizer.validation.invalidEmail" : null },
    { id: "contactPhone",         label: "upgradeToOrganizer.fields.phone",            placeholder: "upgradeToOrganizer.fields.placeholders.phone",         type: "tel",  half: true,  required: true, validate: (v) => !/^\+?[\d\s\-(]{7,20}$/.test(v) ? "upgradeToOrganizer.validation.invalidPhone" : null },
  ...
  company: [
    ...
    { id: "contactName",   label: "upgradeToOrganizer.fields.contactName",    placeholder: "upgradeToOrganizer.fields.placeholders.name",         type: "text", half: true,  required: true, validate: (v) => v.trim().length < 2 ? "upgradeToOrganizer.validation.nameRequired" : null },
