    ...
    <>
      <div className=" font-display min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 md:px-20 lg:px-20">
        <div
          ...
          style={{ background: `url('images/CompleteRegister.png')` ,backgroundSize: 'cover'}}
        >
          <ProgressBar step={'Complete'} />
          <Title>Completed!!</Title>
          <div className="h-120 flex flex-col justify-center items-center ">
            <img src="images/CompleteSign.png" alt="" className="w-fit h-20 lg:h-40 md:h-30 sm:h-20 object-cover mb-4"/>
            <h1 className="lg:text-5xl md:text-4xl text-3xl mb-4 font-extrabold leading-tight text-center  ">Thank You for Signing Up!</h1>
            <p className="w-3/4 lg:p-8  text-center">Your account has been successfully created. Welcome to the community! You can now explore and book unique spaces for your parties, events, and workspaces.  </p>
