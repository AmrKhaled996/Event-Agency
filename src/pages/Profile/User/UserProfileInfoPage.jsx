...
function UserProfilePage() {
  ...
  return (
    <UserProfileMainLayout openDialog={openDialog} dialogMessage={dialogMessage} loading={loading} setopenDialog={setopenDialog}>
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-12">
            <UserProfileInfoItem label="Age">{accountData?.age}</UserProfileInfoItem>

            <UserProfileInfoItem label="Gender">{accountData?.gender}</UserProfileInfoItem>
          ...
          <div className="mt-12">
            ...
            <div className="flex flex-wrap gap-2 pl-4">
              { accountData?.preferences && accountData?.preferences.map((interest) => (
                <Badge
                key={interest.id}
